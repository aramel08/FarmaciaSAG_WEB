    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="RegistroUsuario.php" method="POST" autocomplete="">
                    ...
                    <div class="link login-link text-center">¿Ya eres usuario? <a href="LoginUsuario.php">Entra aquí</a></div>
                </form>
            </div>
        </div>
    </div>
